...
- Add query `_search` for searching entries by text using a search adapter passed to `createClient()`
- Add directive `@Searchable` to explicitly mark types and fields as searchable
...
## [1.0.0-beta.9] - 2026-02-26

### Fixed

- Fix broken reference evaluation on mutating entries with non-null fields

## [1.0.0-beta.8] - 2026-02-26
...
- Expose GitAdapterErrors as GraphQLErrors to enable consistent error handling for callers

## [1.0.0-beta.3] - 2025-11-08
